...
class MainWindow():
    def __init__(self):
        ...
        plane_img = pygame.image.load('resources/image/shoot.png')  # 所有飞机图片
    ...
    def updateScore(self, score):
        ...
        score_text = score_font.render("Score: {}".format(score), True, (128, 128, 128))
